...
%-----------------------------
\newcommand{\mytitle}{Keel Mori Theorem}
\newcommand{\autor}{M. Sc. \\ Jonathan Wassermann}
...
%-----------------------------
\newcommand{\courseofstudy}{Mathematik}
...
\newcommand{\myfaculty}{Fakultät II -- Mathematik und Naturwissenschaften}
\newcommand{\myinstitute}{Institut für Mathematik}
\newcommand{\mydepartment}{Algorithmische Algebra}
\newcommand{\myplace}{Berlin}
\newcommand{\mysupervisor}{Dr.~Dominic Oliver Brooks Bunett}
\newboolean{isSG}
% Options:
