...
\begin{remark}
	The sheaf condition is a local property.
\end{remark}
...
\begin{corollary}\label{cor:limit-sheaf}
	By \cite[]{MacLaneCFWM}, the category $\Sh{\CatC,J}$ is complete. In particular the limit of sheaves is again a sheaf and is calculated in the full subcategory $\PshC$ of presheaves.
\end{corollary}