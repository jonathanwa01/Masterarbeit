...
\begin{proof}
	...
	\]
	Under the identification $\pi_1^*N \cong N\otimes_R S$ and $\pi_2^*N \cong S\otimes_R N$ the $S\otimes_R S$, $\alpha$ is precisely an $S\times_R S$-linear morphism $N\otimes_R S\to S\otimes_R N$ satisfying the cocycle compatibility over $S\otimes_R S\otimes_R S$.
